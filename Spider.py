...
class Spider:
    ...
    def _logState(self):
        ...
        self.browser.save_full_page_screenshot(
            "./states/" + str(self.state_index) + ".png"
        )
        self.state_index += 1
    ...
    def run(self):
        try:
            select = Select(
                self.browser.find_element("id", "ctl00_mainContent_dllCampus")
            )
            ...
            link = self.browser.find_element(
                "xpath", "/html/body/form/div[4]/table/tbody/tr[1]/td[1]/ul/li[5]/a"
            )
            link.click()
